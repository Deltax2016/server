        ...
        return (
            ...
            <Grid container justify="center" spacing={16}>
              ...
              <Grid container justify="center" spacing={16}>
                ...
                <Button onClick={this.state.enabled[1] == false ? () => this.handleEnableAudio(1) : () => this.handleDisableAudio(1)}><RemoteVideoView stream={this.props.remoteStream[1]} upload={this.props.upload} id={'remoteview'} sound={this.state.enabled[1]} num={2}/> </Button>
                </Grid>
              </Grid> : null
          }
          </div>
